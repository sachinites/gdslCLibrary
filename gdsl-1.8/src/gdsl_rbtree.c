...
#define TCONTENT(T, n)    ( (T->offset ? (char *)(&n) - T->offset : (n)->content))    
...
static void 
rbtree_destroy (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, 
		gdsl_free_func_t f);
...
static gdsl_rbtree_node_t
rbtree_search (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, 
...
static gdsl_element_t
rbtree_prefix_parse (gdsl_rbtree_t t, gdsl_rbtree_node_t root, gdsl_rbtree_node_t sent, 
		     gdsl_map_func_t map_f, void* d);

static gdsl_element_t
rbtree_infix_parse (gdsl_rbtree_t t, gdsl_rbtree_node_t root, gdsl_rbtree_node_t sent, 
		    gdsl_map_func_t map_f, void* d);

static gdsl_element_t
rbtree_postfix_parse (gdsl_rbtree_t t, gdsl_rbtree_node_t root, gdsl_rbtree_node_t sent, 
		      gdsl_map_func_t map_f, void* d);

static void
rbtree_write (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, 
	      gdsl_write_func_t map_f, FILE* file, void* d);

static void
rbtree_write_xml (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, 
		  gdsl_write_func_t write_f, FILE* file, void* d);

static void
rbtree_dump (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, gdsl_write_func_t f, 
	     FILE* file, void* d);
...
gdsl_rbtree_free (gdsl_rbtree_t t)
{
    ...
    rbtree_destroy (t, ROOT (t), SENT (t), t->free_f);
...
gdsl_rbtree_insert (gdsl_rbtree_t t, void* v, int* rc)
{
    ...
    *rc = GDSL_INSERTED;
	...
	{
	    parent = root;
	    comp = t->comp_f (TCONTENT (t, root), v);

	    /* Found v */
	    if (comp == 0)
		{
		    *rc = GDSL_FOUND;
		    return TCONTENT (t, root);
		}
...
gdsl_rbtree_remove (gdsl_rbtree_t t, void* v)
{
    ...
    n = rbtree_search (t, ROOT (t), SENT (t), t->comp_f, v);
...
gdsl_rbtree_search (const gdsl_rbtree_t t, gdsl_compare_func_t comp_f, void* v)
{
    ...
    n = rbtree_search (t, ROOT (t), SENT (t), comp_f ? comp_f : t->comp_f, v);

    return (n == NULL) ? NULL : TCONTENT (t, n);
}
...
gdsl_rbtree_map_prefix (const gdsl_rbtree_t t, gdsl_map_func_t map_f, void* d)
{
    ...
    return rbtree_prefix_parse (t, ROOT (t), SENT (t), map_f, d);
}
...
gdsl_rbtree_map_infix (const gdsl_rbtree_t t, gdsl_map_func_t map_f, void* d)
{
    ...
    return rbtree_infix_parse (t, ROOT (t), SENT (t), map_f, d);
}
...
gdsl_rbtree_map_postfix (const gdsl_rbtree_t t, gdsl_map_func_t map_f, void* d)
{
    ...
    return rbtree_postfix_parse (t, ROOT (t), SENT (t), map_f, d);
}
		   ...
		   FILE* file, void* d)
{
    ...
    rbtree_write (t, ROOT (t), SENT (t), write_f, file, d);
}
		       ...
		       FILE* file, void* d)
{
    ...
    rbtree_write_xml (t, ROOT (t), SENT (t), write_f, file, d);
		  ...
		  FILE* file, void* d)
{
    ...
    rbtree_dump (t, ROOT (t), SENT (t), write_f, file, d);
...
static void 
rbtree_destroy (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, gdsl_free_func_t free_f)
{
    if (n != sent)
	{
	    rbtree_destroy (t, LEFT (n), sent, free_f);
	    rbtree_destroy (t, RIGHT (n), sent, free_f);
	    free_f (TCONTENT (t,n));
	    free (n);
	}
}
...
static gdsl_rbtree_node_t
rbtree_search (gdsl_rbtree_t t, gdsl_rbtree_node_t root, gdsl_rbtree_node_t sent, 
		     ...
		     gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    gdsl_element_t e = TCONTENT (t,root);
	    ...
	    e = rbtree_prefix_parse (t, LEFT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}

	    e = rbtree_prefix_parse (t, RIGHT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}
		    ...
		    gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    ...
	    e = rbtree_infix_parse (t, LEFT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}
	    ...
	    e = rbtree_infix_parse (t, RIGHT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}
		      ...
		      gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    ...
	    e = rbtree_postfix_parse (t, LEFT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}

	    e = rbtree_postfix_parse (t, RIGHT (root), sent, map_f, d);
	    if (e != NULL)
		{
		    return e;
		}
	      ...
	      gdsl_write_func_t write_f, FILE* file, void* d)
{
    if (n != sent)
	{
	    rbtree_write (t, LEFT (n), sent, write_f, file, d);
	    write_f (TCONTENT (t,n), file, get_location (n, sent), d);
	    rbtree_write (t, RIGHT (n), sent, write_f, file, d);
	}
}
		  ...
		  gdsl_write_func_t write_f, FILE* file, void* d)
{
    if (n != sent)
	{
	    rbtree_write_xml (t, LEFT (n), sent, write_f, file, d);
	    ...
	    if (write_f != NULL && TCONTENT (t,n) != NULL)
		{
		    write_f (TCONTENT (t,n), file, get_location (n, sent), d);
		}
	    ...
	    rbtree_write_xml (t,RIGHT (n), sent, write_f, file, d);
	}
}

static void
rbtree_dump (gdsl_rbtree_t t, gdsl_rbtree_node_t n, gdsl_rbtree_node_t sent, gdsl_write_func_t write_f, 
	     FILE* file, void* d)
{
    if (n != sent)
	{
	    rbtree_dump (t, LEFT (n), sent, write_f, file, d);
	    ...
	    if (TCONTENT (t,n))
		{
		    fprintf (file, " CONTENT=\"%p\"", (void *) TCONTENT (t,n));
		}
	    else
		{
	    ...
	    rbtree_dump (t, RIGHT (n), sent, write_f, file, d);
	}
}
